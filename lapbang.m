function varargout = lapbang(varargin)
% LAPBANG M-file for lapbang.fig
%      LAPBANG, by itself, creates a new LAPBANG or raises the existing
%      singleton*.
%
%      H = LAPBANG returns the handle to a new LAPBANG or the handle to
%      the existing singleton*.
%
%      LAPBANG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LAPBANG.M with the given input arguments.
%
%      LAPBANG('Property','Value',...) creates a new LAPBANG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before lapbang_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to lapbang_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help lapbang
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @lapbang_OpeningFcn, ...
                   'gui_OutputFcn',  @lapbang_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
if nargin & isstr(varargin{1})
    gui_State = str2func(varargin{1});
end
...
% --- Executes just before lapbang is made visible.
function lapbang_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to lapbang (see VARARGIN)

% Choose default command line output for lapbang
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes lapbang wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = lapbang_OutputFcn(hObject, eventdata, handles)
